            ...
            <div className={ styles.header }>
                ...
                <div className={ styles.header__social } >
                    <div className={ styles.header__social_tel }>
                        <p>Call Us:</p>
                        <a className={ styles.header__social_tel_link } href="tel:0012345678">(00) 1234 5678</a>
                    </div>
                    <div >
                        <a className={ styles.header__social_icons } href="#"> <AiFillFacebook /> </a>
                        <a className={ styles.header__social_icons } href="#"> <AiFillInstagram /> </a>
                    </div>
                </div>
            </div>
        </div>
