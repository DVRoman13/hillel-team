               ...
               <div className={styles.container__column_qty}>
                    <div className={styles.column_qty__input_wrapper}>
                         ...
                         <div className={styles.button_wrapper}>
                              <button onClick={() => setValue(prev => prev + 1)}><img src={top} alt="" /></button>
                              <button style={{marginBottom: '2px'}} onClick={() => setValue(prev => prev !== 1 ? prev-1 : prev)}><img src={bottom} alt="" /></button>
                         </div>
                    </div>
               </div>
